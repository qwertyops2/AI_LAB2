...
# возьмем два признака, чтобы было удобне визуализировать задачу нужно забирать 3 числа
...
# проверим как это работает (веса зададим пока произвольно) увеличить колво весов
...
#циклы не меняются
#постораться сдеалть визуализацию в трехмерном пространстве
